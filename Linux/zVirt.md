...
Команды для очистки хоста после неудачного развертывания

Для архитектуры **Hosted Engine** :

```
ovirt-hosted-engine-c1eanup
```

Для архитектуры **Standalone**:
...
##### Основные параметры центра данных

| Параметр                                     | Описание                                                                                                                                                                                     |
| -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Имя (Name)                                   | Имя должно быть уникальным и представлять собой любую комбинацию латинских букв в верхнем и нижнем регистре, цифр, дефисов и знаков подчеркивания                                            |
| Тип хранилища (Storage Туре)                 | Позволяет выбрать тип подключаемого хранилища: локальное или общедоступное. Под локальным хранилищем понимается использование локальных накопителей хоста, добавленного в этот центр данных. |
| Версия совместимости (Compatibility Version) | Указывает на то, какая версия совместимости установлена для кластеров этого центра данных                                                                                                    |
| Режим квотирования (Quota Mode)              | Указывает как в этом центре данных будут применяться квоты: -	Выключено - квоты отключены. -	Аудит - применяется "мягкое" квотирование. -	Принудительно - применяется "жесткое" квотирование |
## Управление кластерами

![[Pasted image 20260210091455.png]]

##### Категории параметров кластера
