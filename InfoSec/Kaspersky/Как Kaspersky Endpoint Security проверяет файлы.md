...
- [[KSC Защита]] — этот разбор входит в конспект (раздел 3.1), там же практические настройки Защиты от файловых угроз.
- [[Глоссарий Kaspersky]] — термины: сигнатура, эмуляция, KSN.
