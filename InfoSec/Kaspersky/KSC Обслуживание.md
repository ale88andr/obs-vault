...
### 3. Как организовать резервное копирование

Резервная копия данных Kaspersky Security Center включает практически все видимые и невидимые объекты управления и настройки: всю базу данных, структуру групп администрирования, все задачи и политики, шаблоны отчетов, инсталляционные пакеты3, созданные выборки событий и компьютеров, сертификат Сервера администрирования и т. д. Не резервируются только обновления в серверном хранилище, поскольку к моменту восстановления из резервной копии они все равно успеют устареть.
...
![[Pasted image 20260217163628.png]]
