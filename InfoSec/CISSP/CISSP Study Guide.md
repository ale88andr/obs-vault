...
**Управление безопасностью должно охватывать каждый аспект организации, включая организационные процессы слияний, разделений и управления.**

Будьте осведомлены о рисках при **слияниях** (поскольку состояние ИТ-среды, которую предстоит интегрировать, неизвестно — ключевое значение имеет должная осмотрительность) и **разделениях** (как разделить ИТ-инфраструктуру и что делать с учётными записями и удостоверениями).

Понимайте ценность **комитетов по управлению** (управление поставщиками, управление проектами, управление архитектурой и т. д.).

Руководители, менеджеры и назначенные лица собираются для рассмотрения архитектуры, проектов и инцидентов (в области безопасности или других), а также для утверждения новых стратегий или направлений.

Цель — свежий взгляд, часто со стороны людей, не сосредоточенных исключительно на информационной безопасности.

**При оценке третьей стороны для интеграции в вашу систему безопасности учитывайте следующее:**

- Оценка на месте (on-site assessment)
- Обмен и анализ документации (document exchange and review)
- Анализ процессов и политик (process/policy review)
- Аудит третьей стороны (third-party audit)
