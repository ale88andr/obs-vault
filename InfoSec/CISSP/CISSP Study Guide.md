...
- **Атака агрегации (Aggregation attack)**: основана на математике; процесс, при котором SQL предоставляет ряд функций, объединяющих записи из одной или нескольких таблиц для получения потенциально полезной информации.
- **Атака вывода (Inference attack)**: основана на человеческих умозаключениях; включает в себя объединение нескольких фрагментов неконфиденциальной информации для получения доступа к информации, которая должна быть классифицирована на более высоком уровне; вывод использует **дедуктивные способности человеческого разума**, а не чисто математические возможности платформ баз данных.
