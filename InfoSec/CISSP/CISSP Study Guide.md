...
### 3.4 Понимание возможностей безопасности информационных систем (IS)
...
Интерфейс — это также способ, с помощью которого два или более систем взаимодействуют.

Будьте осведомлены о распространённых возможностях безопасности интерфейсов:
