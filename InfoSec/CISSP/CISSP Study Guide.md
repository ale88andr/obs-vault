...
- Доступ к шкафу коммутации должен быть ограничен уполномоченным персоналом, ответственным за управление ИТ‑оборудованием. 
- Используйте контроль доступа на дверях (электронная система пропусков или электронный кодовый замок). 
- С точки зрения планировки, шкафы коммутации должны быть доступны только в приватных зонах внутренних помещений здания; для доступа к шкафу коммутации человек должен пройти через пункт приёма посетителей и контролируемую дверную зону для доступа к шкафу коммутации.