...
- Чёткие должностные инструкции и классификации.
- Меры против сговора.
- Проверка кандидатов: биография, образование, сертификаты, рекомендации.
- Назначение уровней допуска и проверка на благонадёжность.

##### Трудовые соглашения и политика

- **Трудовой договор**: обязанности, оплата, условия увольнения.
- **Документы**:
    - NDA — соглашение о неразглашении.
    - AUP — политика допустимого использования.
    - Non-compete — запрет на конкуренцию.
- Чем подробнее договор — тем меньше рисков при увольнении.
- Соглашения помогают предотвратить утечку информации.

##### Соблюдение и контроль

- **Compliance** — соблюдение норм, стандартов и политик.
- Требуется обучение сотрудников и регулярное подтверждение знаний.
- Нарушения — основание для санкций.
- PII (персональные данные) должны храниться безопасно и доступно только по необходимости.
- Документированная политика конфиденциальности обязательна.

##### Процессы: приём, перевод, увольнение

- **Onboarding**: стандартизированный ввод нового сотрудника.
- **Transfer**: пересмотр прав доступа при смене должности.
- **Offboarding**: удаление из IAM, физическое сопровождение при уходе.

##### Работа с подрядчиками и внешними партнёрами

- Аутсорсинг требует контроля: доступ, обмен документами, аудит.
- Важны соглашения: SLA, политика безопасности, процедуры оценки.
- Примеры: дата-центры, техподдержка, разработка ПО.
