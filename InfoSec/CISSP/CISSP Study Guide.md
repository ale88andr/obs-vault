...
Эта цель относится к **выявлению уязвимостей** и соответствующих **мер по их смягчению и решений**; ключевым моментом является **понимание типов уязвимостей**, которые обычно присутствуют в различных средах, и **вариантов их устранения**.