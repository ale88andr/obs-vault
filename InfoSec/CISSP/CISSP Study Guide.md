...
- Шкаф коммутации также известен как помещение распределения проводки на объекте, главная распределительная рамка (MDF), промежуточная распределительная рамка (IDF) и телекоммуникационная комната, и в (ISC)² CISSP цель 3.9.1 он называется IDF, где сетевые кабели для здания или этажа подключаются к оборудованию (например, патч‑панели, коммутаторы, маршрутизаторы, LAN‑удлинители и т.д.). Обычно включает телекоммуникационные и сетевые устройства, системы сигнализации, щиты автоматического ввода/вывода, блоки распределения, беспроводные точки доступа, видео/системы безопасности. Может включать небольшое количество серверов. Доступ к шкафу коммутации/IDF должен быть ограничен уполномоченным персоналом, ответственным за управление ИТ‑оборудованием. Используйте контроль доступа на дверях (т.е. электронная система пропусков или электронный кодовый замок). С точки зрения планировки, шкафы коммутации должны быть доступны только в приватных зонах внутренних помещений здания; для доступа к шкафу коммутации человек должен пройти через пункт приёма посетителей и контролируемую дверную зону до входа в шкаф коммутации.