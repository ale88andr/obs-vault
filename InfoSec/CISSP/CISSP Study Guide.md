...
Полный перебор: атака, которая пытается каждую возможную допустимую комбинацию для ключа или пароля. Она включает использование огромного объёма вычислительной мощности для методичного подбора ключа, используемого для защиты криптографических коммуникаций.